...
public slots:
    ...
    // AIOS: токен VPNPan из конфига сервера (пустой serverId = сервер по умолчанию; пустая строка если нет токена)
    Q_INVOKABLE QString aiosTokenForServer(const QString &serverId = QString()) const;
