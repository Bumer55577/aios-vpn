...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("AIOS VPN logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("AIOS VPN service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/AIOS VPN service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
