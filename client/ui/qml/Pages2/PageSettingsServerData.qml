...
PageType {
    ...
    QtObject {
        ...
        readonly property string title: qsTr("Check the server for previously installed AIOS services")
    ...
    QtObject {
        ...
        readonly property var clickedHandler: function() {
            ...
            var descriptionText = qsTr("All installed AIOS VPN services will still remain on the server.")
            var yesButtonText = qsTr("Continue")
            var noButtonText = qsTr("Cancel")
    ...
    QtObject {
        ...
        property bool isVisible: root.isServerWithWriteAccess
        readonly property string title: qsTr("Clear server from AIOS software")
        readonly property string description: ""
        readonly property var tColor: AmneziaStyle.color.vibrantRed
        readonly property var clickedHandler: function() {
            var headerText = qsTr("Do you want to clear server from AIOS software?")
            ...
            var yesButtonFunction = function() {
                if (ServersUiController.isDefaultServerCurrentlyProcessed() && ConnectionController.isConnected) {
                    PageController.showNotificationMessage(qsTr("Cannot clear server from AIOS software during active connection"))
                } else {
