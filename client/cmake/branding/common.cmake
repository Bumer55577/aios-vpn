if(NOT CLIENT_TARGET_NAME)
    set(CLIENT_TARGET_NAME "AIOSVPN" CACHE STRING "Client executable target name")
endif()
if(NOT CLIENT_APPLICATION_NAME)
    set(CLIENT_APPLICATION_NAME "AIOSVPN" CACHE STRING "Application display and executable name")
endif()
if(NOT CLIENT_SERVICE_NAME)
    set(CLIENT_SERVICE_NAME "AIOSVPN-service" CACHE STRING "Service executable name")
endif()
if(NOT CLIENT_ORGANIZATION_NAME)
    set(CLIENT_ORGANIZATION_NAME "AIOS.VPN" CACHE STRING "QSettings organization name")
endif()
if(NOT CLIENT_APP_INSTANCE_NAME)
    set(CLIENT_APP_INSTANCE_NAME "AIOSVPNInstance" CACHE STRING "Single-instance local server name")
endif()
